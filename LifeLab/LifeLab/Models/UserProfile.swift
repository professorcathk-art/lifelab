...
struct StrengthResponse: Codable, Identifiable {
    ...
    init(id: UUID = UUID(), questionId: Int, question: String, selectedKeywords: [String] = [], userAnswer: String? = nil) {
        self.id = id
...
struct ValueRanking: Codable, Identifiable {
    ...
    var isGreyedOut: Bool // Marked as unimportant
    
    init(id: UUID = UUID(), value: CoreValue, rank: Int = 0, relatedMemory: String? = nil, isGreyedOut: Bool = false) {
        self.id = id
        self.value = value
        self.rank = rank
